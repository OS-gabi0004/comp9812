...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  .label current_screen_line_26 = 6
  .label current_screen_line_52 = 6
  .label current_screen_line_53 = 6
  .label current_screen_line_54 = 6
  .label current_screen_line_55 = 6
  .label current_screen_line_56 = 6
...
// print_hex(word zeropage($f) value)
print_hex: {
    .label __3 = $13
    .label __6 = $15
    .label value = $f
...
.segment Data
  MESSAGE: .text "checkpoint 3.2 by gabi0004"
  .byte 0
.segment Syscall
  SYSCALLS: .byte JMP
  .word syscall00
